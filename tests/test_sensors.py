import os
import pytest
from app.getters.sensors import fetch_sensors_modbus, fetch_sensors_dnp, fetch_sensor_modbus_by_id, fetch_sensor_dnp_by_id
...
async def test_fetch_sensor_modbus_by_id(auth_token, examples):
    ...
    data_sensor = await fetch_sensor_modbus_by_id(host, auth_token, sensor_id=hardware_id, sensor_id=sensor_id)
    print(data_sensor)
...
async def test_fetch_sensor_dnp_by_id(auth_token, examples):
    ...
    data_sensor = await fetch_sensor_dnp_by_id(host, auth_token, hardware_id=hardware_id, sensor_id=sensor_id)
