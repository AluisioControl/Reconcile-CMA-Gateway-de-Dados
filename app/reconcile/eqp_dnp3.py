...
from app.getters.sensors import parse_sensor_dnp_data
...
# filtar unicos pela coluna id_sen_dnp3
df = df.drop_duplicates(subset=["id_sen_dnp3"])
print("DataFrame:", df)
print("len(df):", len(df))
...
db_table = "EQP_DNP3"  # Nome da tabela no banco de dados
