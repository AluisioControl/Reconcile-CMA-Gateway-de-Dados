...
gateway_translate = [
    ["CMA Web old","CMA Web new","Lógica de montagem","Gateway de Dados","Banco Middlware","Import ScadaLTS","Json Rabbitmq"],
    ["ID","id","id_gtw","","","",""],
    ...
    ["Substation Name","name","name_sub","subestacao","subestacao","","Subestacao"],
    ["Substation Active","active","active_sub","","","",""],
    ["SAP Abbreviation","sapAbbreviation","sapAbbreviation_sub","regional","regional","","Regional"],
]
...
sensores_modbus_translate = [
    ...
    ["Actualization Period","Actualization Period","actualizationPeriod_sen","updatePeriodType","updatePeriodType","updatePeriodType",""],
    ["Actualization Time","Actualization Time","actualizationTime_sen","updatePeriods","updatePeriods","updatePeriods",""],
    ["Max Register Read","Max Register Read","maxRegisterRead_sen","maxReadRegisterCount","maxReadRegisterCount","maxReadRegisterCount",""],
    ["Max Register Write","Max Register Write","maxRegisterWrite_sen","maxWriteRegisterCount","maxWriteRegisterCount","maxWriteRegisterCount",""],
    ["Max Register Bits Read","Max Register Bits Read","maxRegisterBitsRead_sen","maxReadBitCount","maxReadBitCount","maxReadBitCount",""],
    ["Active","Active","active_sen","enabled","enabled","enabled","Status"],
    ["Manufacturer ID","Manufacturer ID","id_man","","","",""],
    ["Manufacturer Name","Manufacturer Name","name_man","fabricante","fabricante","","Fabricante"],
...
registradores_modbus_translate = [
    ...
    ["Address Slave","addressSlave","addressSlave_reg_mod","slaveId","slaveId","slaveId",""],
    ["Address Register","addressRegister","addressRegister_reg_mod","offset","offset","offset","Registrador"],
    ["Register Modbus Type","registerModbusType","registerModbusType_reg_mod","range","range","range",""],
    ["Register Data Format","registerDataFormat","registerDataFormat_reg_mod","modbusDataType","modbusDataType","modbusDataType",""],
    ["Bit","bit","bit_reg_mod","bit","bit","bit",""],
    ["Multiplier","multiplier","multiplier_reg_mod","multiplier","multiplier","multiplier",""],
    ["Additive","additive","additive_reg_mod","additive","additive","additive",""],
    ...
    ["Sensor Modbus Actualization Period","actualizationPeriod","actualizationPeriod_sen","","","",""],
    ["Sensor Modbus Actualization Time","actualizationTime","actualizationTime_sen","","","",""],
    ["Sensor Modbus Max Register Read","maxRegisterRead","maxRegisterRead_sen","","","",""],
    ["Sensor Modbus Max Register Write","maxRegisterWrite","maxRegisterWrite_sen","","","",""],
    ["Sensor Modbus Max Register Bits Read","maxRegisterBitsRead","maxRegisterBitsRead_sen","","","",""],
    ...
    ["Sensor Modbus Manufacturer Active","active","active_man_reg_mod","","","",""],
    ...
    ["Sensor Type ID","id","id_sen_reg_mod (duplicado)","","","",""],
    ["Sensor Type Name","name","name_sen_reg_mod (duplicado)","classificacao","classificacao","","Classificacao"],
    ["Sensor Type Active","active","active_sen_reg_mod (duplicado)","","","",""],
],


sensores_dnp3_translate = [
    ["CMA Web","CMA Web new","Lógica de montagem","Gateway de Dados","Banco Middlware","Import ScadaLTS","Json Rabbitmq"],
    ...
    ["Attempts","attempts","attempts_dnp_reg_dnp3","retries","retries","retries",""],
    ["Time Limit","timeLimit","timeLimit_dnp_reg_dnp3","timeout","timeout","timeout",""],
    ["Actualization Period","actualizationPeriod","actualizationPeriod_dnp_reg_dnp3","eventsPeriodType","eventsPeriodType","eventsPeriodType",""],
    ["Poll RBE Period","pollRbePeriod","pollRbePeriod_dnp_reg_dnp3","rbePollPeriods","rbePollPeriods","rbePollPeriods",""],
    ["Poll Static Period","pollStaticPeriod","pollStaticPeriod_dnp_reg_dnp3","staticPollPeriods","staticPollPeriods","staticPollPeriods",""],
    ["Address Source","addressSource","addressSource_dnp_reg_dnp3","sourceAddress","sourceAddress","sourceAddress",""],
    ["Address Slave","addressSlave","addressSlave_dnp_reg_dnp3","slaveAddress","slaveAddress","slaveAddress",""],
    ["Active","active","active_dnp_reg_dnp3","enabled","enabled","enabled","Status"],
    ["Manufacturer ID","id","id_man_reg_dnp3","","","",""],
    ["Manufacturer Name","name","name_man_reg_dnp3","fabricante","fabricante","","Fabricante"],
...
registradores_dnp3_translate = [
    ...
    ["Description","description","description_reg_dnp3","classificacao","classificacao","",""],
    ...
    ["Register Data Type","registerDataType","registerDataType_reg_dnp3","dnp3DataType","dnp3DataType","dnp3DataType",""],
    ["Register Control Command","registerControlCommand","registerControlCommand_reg_dnp3","controlCommand","controlCommand","controlCommand",""],
    ...
    ["Sensor Type Name","name","name_sen_reg_dnp3","classificacao","classificacao","","Classificacao"],
